...
namespace CaveRoyale
{
    ...
    public class GridHash : IDisposable
    {
        ...
        public void Process(ComputeBuffer positions, ComputeBuffer lifetimes)
        {
            int numParticles = positions.count;

            GridHashingShader.SetInt("Width", numParticles);
            ...
            GridHashingShader.SetBuffer(hashKernelID, "Lifetimes", lifetimes);
            GridHashingShader.SetBuffer(hashKernelID, "Positions", positions);
        ...
        private void MapTable()
        {
            ...
            GridHashingShader.SetInt("Width", TotalParticles);
